package com.upgrad.kafka.producer;

import java.io.Serializable;

public class LoginDetails_Core implements Serializable{
    ...
    public LoginDetails_Core(){
    }
    
    public LoginDetails_Core(String username, String product) {
        super();
        this.username = username;
        this.product = product;
    }
    
    public LoginDetails_Core(String username, String product, String userAgent, String language, String ipAddress) {
        super();
        this.username = username;
        this.product = product;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LoginDetails_Core other = (LoginDetails_Core) obj;
        if (browser == null) {
