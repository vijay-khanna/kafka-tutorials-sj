...
@Path("/loginconnect")
public class KafkaProducerService_Connect {
    ...
    public String logAccessDetails(@HeaderParam("User-Agent") String userAgent, @HeaderParam("X-Forwarded-For") String ipAddress,
            @HeaderParam("Accept-Language") String language, LoginDetails_Connect details) throws URISyntaxException {
        ...
        String topicName = configProps.getProperty("kafka_topic_connect");
